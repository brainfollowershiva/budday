...
function a()
{
    ...
    var audio=new Audio('./hello-48300.mp3');
    audio.play();
} 
function b()
{
    ...
    var audio=new Audio('./happy-birthday-242244.mp3');
    audio.play();
} 
function c()
{
    ...
    console.log(this.style.backgroundColor="Tan");
    var audio=new Audio('./happy-birthday-to-you-made-by-me-100631.mp3');
    audio.play();
} 
function d()
{
    ...
    console.log(this.style.backgroundColor="Tan");
    var audio=new Audio('./i-love-you-cartoon-voice-136531.mp3');
    audio.play();
} 
function e()
{
    ...
    var audio=new Audio('./happy-birthday-45962.mp3');
    audio.play();
} 
function f()
{
...
function g()
{
    ...
    console.log(this.style.backgroundColor="Tan");
    var audio=new Audio('./girl-happy-birthday-150549.mp3');
    audio.play();
} 
function h()
{
